...
5. To handle server offline issue, we keep pinning checkIn/boardcast method from server remote object (Chat), if we have consecutive connectionExceptions, we know that server is offline. 
